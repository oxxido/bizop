<?php
/**
 * Template Name:Recent Review Form
 *
 */
?>
...
if ($is_pro_platinum == 1){ ?>
    ...
    <div class="clearfix">
        <div class="leftReviewFrm">
            <h3 class="leadblack media">RECENT REVIEWS</h3>
            <br>
        ...
        <div class="listReview">
            <h3 class="title"><img src="<?php bloginfo('template_url'); ?>/dist/images/list-title-icon.jpg" alt=""/> SUBMIT A REVIEWS</h3>
            <form id="front_end" name="front_end" method="post" action="">
                ...
                <div class="searchfrmInput">
                    ...
                    <input type="radio" name="reviewtype" value="101" /> <label for="offer">Offer</label>
                    <br/>
                    <input type="radio" name="reviewtype" value="102" /> <label for="network">Network</label>
                    <br/>
                    <input type="radio" name="reviewtype" value="103" /> <label for="bizop">Biz Op</label>
                    <br/>
                    <input type="radio" name="reviewtype" value="104" /> <label for="mlm">MLM</label>
                    <br/>
                    <input type="radio" name="reviewtype" value="105" /> <label for="offercreative">Offer Creative</label>
                </div>
                <div class="searchfrmInput">
                    <label class="lbl">Please enter description of your review:</label>
                    <textarea class="wp-editor-area" rows="10" name="content" id="content"></textarea>
                </div>
                <div class="searchfrmInput">
                    <input type="radio" name="reviewpublic" value="public" /> <label  for="public">Please make my review public</label>
                    <br/>
                    <input type="radio" name="reviewpublic" value="private" /> <label  for="private">Please make my review private</label>
                </div>
